...
| [Practices for Governing Agentic AI Systems](https://openai.com/index/practices-for-governing-agentic-ai-systems/) | Define lifecycle roles, task suitability, action constraints, meaningful approval, legibility, interruptibility, attribution, safe defaults, and continuing responsibility | Evidence records now require expiry, revalidation triggers, incident gate, and pause/revocation authority | Partial |
