...
Diagram 09 is the published Phase 3.1 model-evaluation view at exact Commit
`bb6b8f28afba0961bb97b24e6050fccaa94d5702`. It shows the SHA-256-bound
synthetic source pools, disjoint temporal training/calibration/evaluation roles,
logistic baseline, calibration challenger, aggregate metrics, unconditional
