...
- Added and froze the planned `P2-CE-004` synthetic campaign scaffold: two intended repetitions of 16 fixed attempts each, comprising eight clean projection matches, four qualification quarantines, and four reference-projector blocks per repetition, with zero retries or exclusions permitted. An initial package against Commit `1945ff283794c42f8eb649e320ba6adf91a6b982` was withheld before publication after review found that its frozen validator accepted non-finite JSON; that package is excluded from the claim denominator and is not evidence. **No valid result ledger, evidence record, or CE-2 result exists yet; `P2-CE-004` remains CE-0 / not evaluated pending a corrected freeze and one new bound execution.**
